...
We can also pass in other graphical parameters. Let's add a title (`main=`), increase the y-axis limit (`ylim=`), reduce the point size to 60% (`cex=`), and reduce the font size of the axis labels to 80% (`cex.axis=`). While we're at it, let's change the colors (`col=`) and remove the suggestive and genome-wide significance lines::
